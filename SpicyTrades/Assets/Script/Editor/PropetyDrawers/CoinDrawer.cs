...
public class CoinDrawer : PropertyDrawer
{
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	{
		...
		EditorGUI.PropertyField(goldRect, property.FindPropertyRelative("Royal"), new GUIContent("Royal"));
		EditorGUI.PropertyField(silverRect, property.FindPropertyRelative("Silver"), new GUIContent("Silver"));
		EditorGUI.PropertyField(chipRect, property.FindPropertyRelative("Chip"), new GUIContent("Chip"));
